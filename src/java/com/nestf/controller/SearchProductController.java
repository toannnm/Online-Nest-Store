...
public class SearchProductController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            List<ProductDTO> searchList = dao.searchProduct(search);
            Random rd = new Random();
            int productID = rd.nextInt(14);
            List<ProductDTO> getRelateList = dao.getListRelateProduct("Tổ yến tinh chế", productID);
            request.setAttribute("LIST_RELATE_PRODUCT", getRelateList);
