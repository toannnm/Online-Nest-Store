 ...
 * @author DELL
 */
@WebServlet(name = "PendingProductServlet", urlPatterns = {"/PendingProductServlet"})
...
//            if (btAction.equalsIgnoreCase("noseller")) {
//                listPending = ProductDAOAdmin.getProductWithoutSeller();
//            } else if (btAction.equalsIgnoreCase("others")) {
//                listPending = ProductDAOAdmin.getProductPendingOthers();
//            } else {
